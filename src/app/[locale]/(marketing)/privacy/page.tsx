  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-extrabold text-navy-500 mb-2">Privacy Policy</h1>
        <p className="text-slate-400 text-sm mb-10">Last updated: April 2025</p>

        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">3. Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">4. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">5. Security</h2>
            <p>We implement industry-standard security measures to protect your data. All data is encrypted in transit and at rest.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">6. Contact</h2>
            <p>For privacy-related questions, contact us at <a href="mailto:hello@mrlabs.io" className="text-cta hover:underline">hello@mrlabs.io</a>.</p>
          </section>
        </div>
      </main>
    </div>
