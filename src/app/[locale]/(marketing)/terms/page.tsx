      ...
      <header className="border-b border-slate-100">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center">
          <Link href={`/${locale}`} className="flex items-center gap-2">
            ...
            <span className="text-xl font-extrabold text-navy-500">WorkPilot</span>
          </Link>
        </div>
      </header>
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-extrabold text-navy-500 mb-2">Terms of Service</h1>
        <p className="text-slate-400 text-sm mb-10">Last updated: April 2025</p>

        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">3. Accounts and Billing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">4. Acceptable Use</h2>
            <p>You agree not to misuse the service, attempt to access unauthorized data, or use the platform for any unlawful purpose.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">5. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">6. Changes to Terms</h2>
            <p>We may update these terms at any time. Continued use of the service after changes constitutes acceptance of the new terms.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-navy-500 mb-3">7. Contact</h2>
            <p>Questions about these terms? Email us at <a href="mailto:hello@mrlabs.io" className="text-cta hover:underline">hello@mrlabs.io</a>.</p>
          </section>
        </div>
      </main>
    </div>
